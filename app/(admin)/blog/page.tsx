            ...
            >
              <div className="flex items-start justify-between gap-2 mb-2">
                ...
                <button
                  ...
                  className="w-6 h-6 flex items-center justify-center rounded-md transition-opacity hover:opacity-80 flex-shrink-0"
                ...
                <tr key={post.id} className="hover:bg-[#f1f5f9] transition-colors" style={{ borderBottom: i < filtered.length - 1 ? '1px solid #cbd5e1' : 'none' }}>
                  ...
                  <td className="px-2 sm:px-4 py-3 align-middle">
                    <div className="flex items-center gap-1 justify-center">
                      ...
                      <button onClick={() => deletePost(post.id, post.title)} disabled={deleting === post.id} className="w-8 h-8 flex items-center justify-center rounded-lg transition-opacity disabled:opacity-50 hover:opacity-80" style={{ background: '#ef4444', color: 'white' }} title="Delete">
